...
class LibraryManager:
    ...
    def delete(self, cell_name):
        ...
        self.save_workbook()
        print(f"Content of cell {cell_name} deleted successfully.")
    ...
    def deletedata(self):
        ...
        for row in self.worksheet.iter_rows(min_row=2, values_only=False):
            if row[0].value == book_to_delete:
                found = True
                print("What would you like to delete?")
                print("1. Title")
                print("2. Author")
                print("3. Publication Year")
                print("4. Delete entire row")
                print("5. Cancel")
                ...
                if choice == '1':
                    ...
                    row[2].value = None
                    print("Publication year deleted successfully!")
                ...
                self.save_workbook()
                print(f"Book '{self.file_name}' has been updated successfully!")
                return
